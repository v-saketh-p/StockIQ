...
Data sourced from yfinance. AI analysis generated by Gemini 2.0 Flash — verify all figures independently. DYOR.
</p>
</body></html>"""
    ...
    def stream_html_report():
        ...
        # 2. Stream Gemini analysis (OpenAI-compatible SSE format)
        try:
            with httpx.stream(
                "POST",
